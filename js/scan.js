...
window.addEventListener("load", function () {
  ...
  let barcodeInput = document.getElementById("result");
  let loader = this.document.getElementById("ScanLoad");
  let submitbtn = this.document.getElementById("submitbarcodebtn");
  let scnbtlTxt = this.document.getElementById("scanBttleTxt");
  let squareScan = this.document.getElementById("scan4angle");
  const hints = new Map();
  ...
  codeReader
    ...
    .then((videoInputDevices) => {
      ...
      codeReader.decodeFromVideoDevice(undefined, "video", (result, err) => {
        ...
        scnbtlTxt.style.display = "block";
        squareScan.style.display = "block";
        ...
        if (result) {
          ...
          if (otherCompanies.includes(result.text)) {
            const coce = firebase
              ...
              .ref()
              .child("bottles")
              .child("Other Companies");
            coce.transaction(function (result) {
              return result + 0.5;
            });

            setTimeout(function () {
              window.location.href = "imgAI";
            }, 600);
            return;
            ...
            this.document.getElementById("errMsg").innerHTML =
              "This bottle cant by recycled, try again later";
  ...
  this.document
    .getElementById("submitbarcodebtn")
    .addEventListener("click", function () {
      const inputBarcode = document.getElementById("result").value;

      const BottleBarcodes = [
        "7072712001203",
        "7033050815105",
        "7033050815020",
        "7033050815822",
      ...
      console.log(BottleBarcodes.length);
